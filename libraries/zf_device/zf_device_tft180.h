...
#define TFT180_SCL_PIN                  D13                                      // 软件 SPI SCK 引脚
#define TFT180_SDA_PIN                  C6                                      // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
...
#define TFT180_RES_PIN                  D15                                      // 液晶复位引脚定义
#define TFT180_DC_PIN                   C7                                      // 液晶命令位引脚定义
#define TFT180_CS_PIN                   A8                                      // CS 片选引脚
#define TFT180_BL_PIN                   D14                                      // 液晶背光引脚定义

#define TFT180_DC(x)                    (x==1)?(gpio_set_level(TFT180_DC_PIN,1)):(gpio_set_level(TFT180_DC_PIN,0))
#define TFT180_RES(x)                   (x==1)?(gpio_set_level(TFT180_RES_PIN,1)):(gpio_set_level(TFT180_RES_PIN,0))
#define TFT180_CS(x)                    (x==1)?(gpio_set_level(TFT180_CS_PIN,1)):(gpio_set_level(TFT180_CS_PIN,0))
#define TFT180_BL(x)                    (x==1)?(gpio_set_level(TFT180_BL_PIN,1)):(gpio_set_level(TFT180_BL_PIN,0))
