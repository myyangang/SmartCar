...
#define ICM20602_SCL_PIN            E2                                          // 软件 IIC SCL 引脚 连接 MPU6050 的 SCL 引脚
#define ICM20602_SDA_PIN            D1                                          // 软件 IIC SDA 引脚 连接 MPU6050 的 SDA 引脚
//====================================================软件 IIC 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
...
//====================================================硬件 SPI 驱动====================================================
#endif
#define ICM20602_CS_PIN             D3                                          // CS 片选引脚
#define ICM20602_CS(x)              (x? (gpio_high(ICM20602_CS_PIN)): (gpio_low(ICM20602_CS_PIN)))
//====================================================软件 SPI 驱动====================================================
#define ICM20602_TIMEOUT_COUNT      0x00FF
#define ICM20602_SCK_PIN        E13
#define ICM20602_MOSI_PIN       E15
#define ICM20602_MISO_PIN       E2
#define ICM20602_CSN_PIN        E0

#define ICM20602_SCK(x)         (x? (gpio_high(ICM20602_SCK_PIN)): (gpio_low(ICM20602_SCK_PIN)))
#define ICM20602_MOSI(x)        (x? (gpio_high(ICM20602_MOSI_PIN)): (gpio_low(ICM20602_MOSI_PIN)))
#define ICM20602_CSN(x)         (x? (gpio_high(ICM20602_CSN_PIN)): (gpio_low(ICM20602_CSN_PIN)))
#define ICM20602_MISO           (gpio_get_level(ICM20602_MISO_PIN))
//====================================================软件 SPI 驱动====================================================
//================================================定义 ICM20602 内部地址================================================
...
extern FLOAT_XYZ Acc_filt,Gry_filt,Acc_filtold;   //滤波后的各通道数据
...
extern float gyro_x_init,gyro_y_init,gyro_z_init;
