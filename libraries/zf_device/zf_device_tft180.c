...
//#define tft180_write_8bit_data(data)    lcd_writeData_simspi(data)
//#define tft180_write_16bit_data(data)   lcd_writeData_16bit_simspi(data)
#define tft180_write_8bit_data    lcd_writeData_simspi
#define tft180_write_16bit_data   lcd_writeData_16bit_simspi
#else
//#define tft180_write_8bit_data(data)    lcd_writeData_simspi(data)
//#define tft180_write_16bit_data(data)   lcd_writeData_16bit_simspi(data)
#define tft180_write_8bit_data    lcd_writeData_simspi
...
void tft180_init (void)
{
    ...
    gpio_init(TFT180_SCL_PIN, GPO, 1, GPIO_PIN_CONFIG);
    gpio_init(TFT180_SDA_PIN, GPO, 1, GPIO_PIN_CONFIG);
