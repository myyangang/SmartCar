...
#define MOTOR_L_PWM_CHANNEL TIM10_PWM_CH1_D1
#define MOTOR_R_PWM_CHANNEL TIM10_PWM_CH3_D5
...
#define CAMERA_WIDTH MT9V03X_DVP_W
#define CAMERA_HEIGHT MT9V03X_DVP_H

#define SERVO_PWM_CHANNEL TIM2_PWM_CH2_B3
#define SERVO_PWM_FREQUENCY 330
#define SERVO_PWM_THEORETICAL_MIN (SERVO_PWM_FREQUENCY/2*PWM_DUTY_MAX/1000)
#define SERVO_PWM_THEORETICAL_MAX (SERVO_PWM_THEORETICAL_MIN*5)
#define SERVO_PWM_THEORETICAL_MIDDLE = ((SERVO_PWM_THEORETICAL_MAX+SERVO_PWM_THEORETICAL_MIN)/6*7) // 4775

// 需要实际测量
#define SERVO_PWM_ACTUAL_MIN 5025 // 最向右转
#define SERVO_PWM_ACTUAL_MAX 6425 // 最向左转
#define SERVO_PWM_ACTUAL_MIDDLE 5675
