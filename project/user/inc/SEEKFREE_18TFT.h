...
#define	TFT_SCL_SIMSPI_PIN 		D10				//定义SPI_SCK引脚
#define	TFT_SDA_SIMSPI_PIN		C6   			//定义SPI_MOSI引脚
#define TFT_REST_SIMSPI_PIN  	D11				//定义复位引脚
#define TFT_DC_SIMSPI_PIN	  	C7				//液晶命令位引脚定义
#define TFT_CS_SIMSPI_PIN	  	A8				//定义SPI_CS引脚
