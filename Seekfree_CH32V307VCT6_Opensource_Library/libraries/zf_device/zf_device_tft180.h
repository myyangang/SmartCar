...
#define TFT180_SCL_PIN                  (E11)                                   // 软件 SPI SCK 引脚
#define TFT180_SDA_PIN                  (E9)                                   // 软件 SPI MOSI 引脚
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
...
#define TFT180_RES_PIN                  (E7)                                    // 液晶复位引脚定义
#define TFT180_DC_PIN                   (B1)                                    // 液晶命令位引脚定义
#define TFT180_CS_PIN                   (C5)                                    // CS 片选引脚
